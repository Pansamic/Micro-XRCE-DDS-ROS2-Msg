...
/*!
 * @file MecanumDriveControllerStateSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    control_msgs_msg_MecanumDriveControllerState topic;
    control_msgs_msg_MecanumDriveControllerState_deserialize_topic(mb, &topic);
