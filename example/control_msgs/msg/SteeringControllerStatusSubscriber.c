...
/*!
 * @file SteeringControllerStatusSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    control_msgs_msg_SteeringControllerStatus topic;
    control_msgs_msg_SteeringControllerStatus_deserialize_topic(mb, &topic);
