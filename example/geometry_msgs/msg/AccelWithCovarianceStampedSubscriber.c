...
/*!
 * @file AccelWithCovarianceStampedSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    geometry_msgs_msg_AccelWithCovarianceStamped topic;
    geometry_msgs_msg_AccelWithCovarianceStamped_deserialize_topic(mb, &topic);
