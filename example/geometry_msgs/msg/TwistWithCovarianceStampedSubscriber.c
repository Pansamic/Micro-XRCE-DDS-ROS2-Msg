...
/*!
 * @file TwistWithCovarianceStampedSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    geometry_msgs_msg_TwistWithCovarianceStamped topic;
    geometry_msgs_msg_TwistWithCovarianceStamped_deserialize_topic(mb, &topic);
