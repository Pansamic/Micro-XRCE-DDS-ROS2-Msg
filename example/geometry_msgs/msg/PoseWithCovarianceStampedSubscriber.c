...
/*!
 * @file PoseWithCovarianceStampedSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    geometry_msgs_msg_PoseWithCovarianceStamped topic;
    geometry_msgs_msg_PoseWithCovarianceStamped_deserialize_topic(mb, &topic);
