...
/*!
 * @file InteractiveMarkerPoseSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    visualization_msgs_msg_InteractiveMarkerPose topic;
    visualization_msgs_msg_InteractiveMarkerPose_deserialize_topic(mb, &topic);
