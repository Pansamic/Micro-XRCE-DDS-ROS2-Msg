...
/*!
 * @file TransitionDescriptionSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    lifecycle_msgs_msg_TransitionDescription topic;
    lifecycle_msgs_msg_TransitionDescription_deserialize_topic(mb, &topic);
