...
/*!
 * @file JointTrajectoryPointSubscriber.c
 * Subscriber example.
 *
        ...
        void* args)
{
    ...
    trajectory_msgs_msg_JointTrajectoryPoint topic;
    trajectory_msgs_msg_JointTrajectoryPoint_deserialize_topic(mb, &topic);
